...
project. <img src="/images/user-features.png"/>
...
| `hasFeature(key)`            |                                            Get the boolean value of a particular _Feature Flag_ e.g. `flagsmith.hasFeature("powerUserFeature") // true`                                            |
| `getValue(key)`              |                                                  Get the value of a particular _Remote Config Value_ e.g. `flagsmith.getValue("font_size") // 10`                                                  |
