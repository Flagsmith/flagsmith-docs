...
| <code>getAllTraits()=> Record&lt;string,string&#124;number&#124;boolean&gt;</code>                                                              |                                                                         Once used with an identified user you can get the value of all traits that are set for them e.g. `flagsmith.getTraits()`                                                                          |
