...
| **LDAP_AUTH_SYNC_USER_RELATIONS**          | custom_auth.ldap.sync_user_groups                                                              | Path to a callable used to sync user realtions                                                                                                                                                                     | django_python3_ldap.utils.sync_user_relations              |
